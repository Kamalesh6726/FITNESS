...
/* FOOD DATABASE */
const foodDatabase = {
pongal:250, coffee:60, tea:50, meals:700,
snacks:200, parotta:300, rice:400,
idly:60, dosa:120, biriyani:600,
cake:250, chapathi:80
};

/* WEEK MENU */
const weeklyMenu = {
Monday:["pongal","coffee","meals"],
Tuesday:["chapathi","tea","meals"],
Wednesday:["idly","biriyani"],
Thursday:["dosa","meals"],
Friday:["pongal","cake"],
Saturday:[],
Sunday:[]
...
if(!foodDatabase[name]) return alert("Food not found");
